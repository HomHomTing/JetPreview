(function () {
  ...
  const icaoCodeIconMap = typeCodeIconMap;
  const icaoCodeMappings = typeMappings.map((item) => ({
    ...item,
    icaoCode: item.icaoCode || item.aircraftTypeCode
  }));
  ...
  root.AIRCRAFT_ICON_CONFIG = {
    ...
    publishedVersion: "icon-map-1.12-icao-code",
