...
Current online/GitHub release packaging target: **1.16**.

The project root is now aligned with the frozen 1.16 release iteration. Frozen historical snapshots are kept in `versions/1.0/`, `versions/1.1/`, `versions/1.2/`, `versions/1.5/`, `versions/1.6/`, `versions/1.8/`, `versions/1.9/`, `versions/1.10/`, `versions/1.11/`, `versions/1.12/`, `versions/1.14/`, and `versions/1.16/`.
