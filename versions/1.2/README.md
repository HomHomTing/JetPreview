# Global BizJet Ops 1.2

Static V1.2 prototype for a web-based aircraft operations map, icon test system, and aircraft type-code icon control console.
...
Current version 1.2 icon mappings are centralized in `aircraft-icon-config.js`.
...
- The aircraft filter is locked to the mixed local icon sample set.
