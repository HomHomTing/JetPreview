...
function loadState() {
  try {
    ...
    return {
      ...
      icons: mergeSeedRecords(parsed.icons, seed.icons, "iconKey", forcedConfigIconKeys),
      mappings: mergeSeedRecords(parsed.mappings, seed.mappings, "aircraftTypeCode", forcedConfigTypeCodes),
      publishedMappings: mergeSeedRecords(parsed.publishedMappings, seed.publishedMappings, "aircraftTypeCode", forcedConfigTypeCodes),
